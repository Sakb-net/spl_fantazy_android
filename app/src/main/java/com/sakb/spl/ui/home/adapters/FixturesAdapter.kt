...
class FixturesAdapter : ListAdapter<HomeResponse.MatchGroup, FixturesAdapter.FixturesViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        FixturesViewHolder(ItemHomeMatchBinding.inflate(LayoutInflater.from(parent.context), parent, false), onClickListener)
    ...
    class FixturesViewHolder(private val binding: ItemHomeMatchBinding,
        ...
        fun bind(data: HomeResponse.MatchGroup) = data.run {
            ...
            itemView.setOnClickListener { onNewsListener?.invoke(this) }
                ...
                Glide.with(binding.team1Iv).load(Constants.baseUrl+imageFirst).override(150) .into( binding.team1Iv)
                Glide.with(binding.team2Iv).load(Constants.baseUrl+imageSecond).override(150) .into( binding.team2Iv)
                /*
