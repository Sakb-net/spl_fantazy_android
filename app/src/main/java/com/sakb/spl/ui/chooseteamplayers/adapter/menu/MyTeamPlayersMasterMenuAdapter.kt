package com.sakb.spl.ui.chooseteamplayers.adapter.menu
...
import kotlinx.android.synthetic.main.parent_item_team_master_recycler_menu.view.*
...
class MyTeamPlayersMasterMenuAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.parent_item_team_master_recycler_menu, parent, false)
        return ViewHolder(v)
    }
