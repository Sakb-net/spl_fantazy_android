...
import kotlinx.android.synthetic.main.transfers_parent_item_team_master_recycler.view.*
...
class MyTeamPlayersMasterAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.transfers_parent_item_team_master_recycler, parent, false)
        return ViewHolder(v)
    }
