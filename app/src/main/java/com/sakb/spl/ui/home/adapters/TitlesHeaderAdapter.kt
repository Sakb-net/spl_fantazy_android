...
class TitlesHeaderAdapter : ListAdapter<String, TitlesHeaderAdapter.FixturesViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        FixturesViewHolder(ItemHomeTitlesBinding.inflate(LayoutInflater.from(parent.context), parent, false), onClickListener)
    ...
    class FixturesViewHolder(private val binding: ItemHomeTitlesBinding,
                         private val onNewsListener: (() -> Unit)?) : RecyclerView.ViewHolder(binding.root) {
